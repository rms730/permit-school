...
Generated: 2025-08-23T19:23:49.741Z
...
- **External Links**: 50
- **Unique Scripts**: 58
- **Unique Environment Variables**: 313
- **Unique File Paths**: 138
...
- **Headings**: 62
- **Links**: 1
- **Commands**: npm run ci, npm run env:check:local, npm run --prefix, npm run version, npm run --version, npm run list
- **Env Vars**: ENVIRONMENT_SETUP, NEXT_PUBLIC_SUPABASE_URL, NEXT_PUBLIC_SUPABASE_ANON_KEY, SUPABASE_SERVICE_ROLE_KEY, RLS...
