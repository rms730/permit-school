...
| ------------------------------------ | ---------- | ------------------------------------------------ | --------------------------- | ---------------------------------------------- | ----------------------------------------------------------- |
| `SUPABASE_URL`                       | root + web | server-only (root), client (web via NEXT_PUBLIC) | local, dev, prod            | `http://127.0.0.1:4000` (local)                | web/src/lib/supabaseClient.ts, web/src/lib/supabaseAdmin.ts |
| `NEXT_PUBLIC_SUPABASE_URL`           | web        | client (public)                                  | local, dev, prod            | `http://127.0.0.1:4000` (local)                | web/src/lib/supabaseClient.ts, web/src/env.ts               |
...
| `OPENAI_API_KEY`                     | root + web | server-only                                      | local, dev, prod            | none                                           | tutor endpoints + ingestion scripts                          |
| `AI_TUTOR_MODEL`                     | web        | server-only                                      | local, dev, prod            | `gpt-4o-mini`                                  | tutor endpoints                                             |
| `AI_EMBED_MODEL`                     | web        | server-only                                      | local, dev, prod            | `text-embedding-3-small`                       | tutor endpoints                                             |
| `AI_MAX_EXCERPT_CHARS`               | web        | server-only                                      | local, dev, prod            | `800`                                          | tutor endpoints                                             |
| `TESTKIT_ON`                         | root       | server-only                                      | local                       | `true`                                         | test scripts                                                |
| `TESTKIT_TOKEN`                      | root       | server-only                                      | local                       | `dev-super-secret`                             | test scripts                                                |
| `BASE_URL`                           | root       | server-only                                      | local, dev, prod            | `http://localhost:3001` (local)                | scripts and tools                                           |
| `APP_BASE_URL`                       | root + web | server-only                                      | local, dev, prod            | `http://localhost:3001` (local)                | email templates                                             |
| `NEXT_PUBLIC_SITE_URL`               | web        | client (public)                                  | local, dev, prod            | `http://localhost:3001` (local)                | metadata, sitemap                                           |
...
| `BILLING_SUCCESS_URL`                | root       | server-only                                      | local, dev, prod            | `http://localhost:3001/billing?status=success` | Stripe redirects                                            |
| `BILLING_CANCEL_URL`                 | root       | server-only                                      | local, dev, prod            | `http://localhost:3001/billing?status=cancel`  | Stripe redirects                                            |
| `STRIPE_PORTAL_RETURN_URL`           | root       | server-only                                      | local, dev, prod            | `http://localhost:3001/billing`                | Stripe portal                                               |
