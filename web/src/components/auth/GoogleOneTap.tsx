...
export default function GoogleOneTap({ onSuccess, onError }: GoogleOneTapProps) {
  ...
  useEffect(() => {
    // Disable Google One-Tap in offline mode
  ...
  // Don't render anything if One-Tap is disabled or in offline mode
  if (isFeatureDisabled('googleOneTap') || process.env.NEXT_PUBLIC_GOOGLE_ONE_TAP !== '1') {
    return null;
  }
